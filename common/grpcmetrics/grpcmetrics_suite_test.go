...
//go:generate protoc --proto_path=$GOPATH/src/github.com/hyperledger/udo/common/grpcmetrics/testpb --go_out=plugins=grpc:$GOPATH/src $GOPATH/src/github.com/hyperledger/udo/common/grpcmetrics/testpb/echo.proto
