...
func TestChaincodeInit(t *testing.T) {
	...
	url := "github.com/hyperledger/udo/core/chaincode/testdata/chaincode/init_private_data"
	...
	url = "github.com/hyperledger/udo/core/chaincode/testdata/chaincode/init_public_data"
