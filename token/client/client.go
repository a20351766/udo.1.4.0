...
import (
	...
	tk "github.com/hyperledger/udo/token"
)
...
//go:generate counterfeiter -o mock/udo_tx_submitter.go -fake-name UDOTxSubmitter . UDOTxSubmitter

type UDOTxSubmitter interface {

	// Submit allows the client to build and submit a udo transaction for fabtoken that has as
...
// TODO to be updated later to have a proper udo header
// createTx is a function that creates a udo tx form an array of bytes.
